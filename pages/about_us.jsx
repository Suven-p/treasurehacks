  ...
  return (
    <div>
      <div className="p-12 text-center bg-[#474e5a] text-white indent-7">
        ...
        <p> FitnessFlow is an app that helps you manage your health routine.</p>
        <p>
          You can add your daily routines, habits you want to change as well as
      ...
      <div className="mt-24 flex justify-center mb-30">
        <div>
          <div className="mx-2 shadow-3xl ">
            ...
            />
            <a href="https://github.com/prasaya">
              <h2 className="text-center">Prasaya</h2>
            </a>
          </div>
        </div>
        ...
        <div>
          <div className="mx-2 shadow-3xl">
            <Image
              ...
              height={150}
            />
            <a href="https://github.com/rijalsankalp">
              <h2 className="text-center">Sankalpa</h2>
            </a>
          </div>
        </div>
        ...
        <div>
          <div className="mx-2 shadow-3xl">
            <Image
              ...
              height={150}
            />
            <a href="https://github.com/voidcu">
              <h2 className="text-center">Saroj</h2>
            </a>
          </div>
        </div>
        ...
        <div>
          <div className="mx-2 shadow-3xl">
            ...
            <a href="https://github.com/Suven-p">
              <h2 className="text-center">Suven</h2>
            </a>
          </div>
        </div>
      </div>
